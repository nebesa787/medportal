	...
	<div id="main">
		<div class="content_wr">
        	...
        	<div class="sidebar">
        		...
        		<?php } elseif (($parcat == 19)||($catpar == 19)||($parcatpar == 19)||($medcat == 19)  ) { ?>
        		...
        		<?php } else { ?>
					<?php if (($medcat != 49)&&($parcat != 20)&&($catpar != 20)&&($parcatpar != 20)&&($medcat != 20)) { ?>
						...
						<?php } elseif (($parcat == 9)||($catpar == 9)||($parcatpar == 9)||($medcat == 9) || ($third_lvl_cat == 9) || ($cat_root_id==9)) { ?>
							<div class="b_add">
					...
					<?php } elseif(($parcat == 20)||($catpar == 20)||($parcatpar == 20)||($medcat == 20)) { ?>
						<?php if ( $detect->isMobile() ) { ?>
						<?php get_sidebar('mobile_filter2'); ?>
						<?php }?>
						<div class="b_add">
				...
				<?php } elseif (($parcat == 7)||($catpar == 7)||($parcatpar == 7)||($medcat == 7)) { ?>
				<?php dynamic_sidebar( 'main-page-banner-right' ); ?>
				<?php } elseif (($parcat == 20)||($catpar == 20)||($parcatpar == 20)||($medcat == 20)) { ?>
				<?php dynamic_sidebar( 'main-page-banner-right' ); ?>
				<?php } else { ?>
				...
				<?php if (($parcat == 19)||($catpar == 19)||($parcatpar == 19)||($medcat == 49)) { ?>
